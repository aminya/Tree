...
public:
   ...
   explicit TreeNode(const TreeNode<DataType>& otherTree);

   TreeNode<DataType>& operator=(TreeNode<DataType> other);

   bool operator<(const TreeNode<DataType>& rhs) const;
   bool operator<=(const TreeNode<DataType>& rhs) const;
   bool operator>(const TreeNode<DataType>& rhs) const;
   bool operator>=(const TreeNode<DataType>& rhs) const;
...
template<typename DataType>
TreeNode<DataType>::TreeNode(const TreeNode<DataType>& otherTree)
...
template<typename DataType>
bool TreeNode<DataType>::operator<(const TreeNode<DataType>& rhs) const
{
...
template<typename DataType>
bool TreeNode<DataType>::GetVisited() const
{
   return m_visited;
}

template<typename DataType>
void TreeNode<DataType>::MarkVisited(const bool visited)
{
   m_visited = visited;
}

template<typename DataType>
std::shared_ptr<TreeNode<DataType>> TreeNode<DataType>::GetParent() const
{
   return m_parent;
}

template<typename DataType>
std::shared_ptr<TreeNode<DataType>> TreeNode<DataType>::AddFirstChild(std::shared_ptr<TreeNode<DataType>>& child)
{
...
template<typename DataType>
std::shared_ptr<TreeNode<DataType>> TreeNode<DataType>::PrependChild(DataType& data)
{
...
template<typename DataType>
std::shared_ptr<TreeNode<DataType>> TreeNode<DataType>::PrependChild(std::shared_ptr<TreeNode<DataType>>& child)
{
...
template<typename DataType>
std::shared_ptr<TreeNode<DataType>> TreeNode<DataType>::AppendChild(DataType& data)
{
...
template<typename DataType>
std::shared_ptr<TreeNode<DataType>> TreeNode<DataType>::AppendChild(std::shared_ptr<TreeNode<DataType>>& child)
{
   child->m_parent = shared_from_this();
...
template<typename DataType>
DataType* TreeNode<DataType>::operator->()
{
   return &m_data;
}
...
template<typename DataType>
const DataType* TreeNode<DataType>::operator->() const
{
   return &m_data;
}
...
template<typename DataType>
std::shared_ptr<TreeNode<DataType>> TreeNode<DataType>::GetFirstChild() const
{
   return m_firstChild;
}

template<typename DataType>
std::shared_ptr<TreeNode<DataType>> TreeNode<DataType>::GetLastChild() const
{
   return m_lastChild;
}

template<typename DataType>
std::shared_ptr<TreeNode<DataType>> TreeNode<DataType>::GetNextSibling() const
{
   return m_nextSibling;
}

template<typename DataType>
std::shared_ptr<TreeNode<DataType>> TreeNode<DataType>::GetPreviousSibling() const
{
   return m_previousSibling;
}

template<typename DataType>
unsigned int TreeNode<DataType>::GetChildCount() const
{
   return m_childCount;
}

template<typename DataType>
unsigned int TreeNode<DataType>::CountAllDescendants() const
{
   return Tree<DataType>::Size(*this) - 1;
}

template<typename DataType>
bool TreeNode<DataType>::HasChildren() const
{
   return m_childCount > 0;
}

template<typename DataType>
void TreeNode<DataType>::DetachFromTree()
{
...
template<typename DataType>
void TreeNode<DataType>::SortChildren(const std::function<bool(TreeNode<DataType>, TreeNode<DataType>)>& comparator)
{
   MergeSort(m_firstChild, comparator);
}

template<typename DataType>
void TreeNode<DataType>::MergeSort(std::shared_ptr<TreeNode<DataType>>& list,
   const std::function<bool(TreeNode<DataType>, TreeNode<DataType>)>& comparator)
{
...
template<typename DataType>
void TreeNode<DataType>::DivideList(std::shared_ptr<TreeNode<DataType>> head,
   std::shared_ptr<TreeNode<DataType>>& lhs, std::shared_ptr<TreeNode<DataType>>& rhs)
{
...
template<typename DataType>
std::shared_ptr<TreeNode<DataType>> TreeNode<DataType>::MergeSortedHalves(std::shared_ptr<TreeNode<DataType>>& lhs,
   std::shared_ptr<TreeNode<DataType>>& rhs,
   const std::function<bool(TreeNode<DataType>, TreeNode<DataType>)>& comparator)
{
...
template<typename DataType>
Tree<DataType>::Tree(DataType data)
   : m_head(new TreeNode<DataType>(data))
{
}

template<typename DataType>
Tree<DataType>::Tree(const Tree<DataType>& otherTree)
   : m_head(otherTree.m_head)
{
}

template<typename DataType>
std::shared_ptr<TreeNode<DataType>> Tree<DataType>::GetHead() const
{
   return m_head;
}
...
template<typename DataType>
unsigned int Tree<DataType>::CountLeafNodes() const
{
...
template<typename DataType>
unsigned int Tree<DataType>::Size(const TreeNode<DataType>& node)
{
   unsigned int count = 0;
...
template<typename DataType>
unsigned int Tree<DataType>::Depth(TreeNode<DataType> node)
{
...
template<typename DataType>
void Tree<DataType>::Print(TreeNode<DataType>& node, std::function<std::wstring(const DataType&)> printer)
{
...
template<typename DataType>
typename Tree<DataType>::SiblingIterator Tree<DataType>::begin(const typename Tree<DataType>::Iterator& iterator) const
{
...
template<typename DataType>
typename Tree<DataType>::SiblingIterator Tree<DataType>::end(const typename Tree<DataType>::Iterator& iterator) const
{
...
template<typename DataType>
typename Tree<DataType>::SiblingIterator Tree<DataType>::beginSibling(const std::shared_ptr<TreeNode<DataType>> node) const
{
   return Tree<DataType>::SiblingIterator(node);
}

template<typename DataType>
typename Tree<DataType>::SiblingIterator Tree<DataType>::endSibling(const std::shared_ptr<TreeNode<DataType>> node) const
{
   Tree<DataType>::SiblingIterator siblingIterator(nullptr);
...
template<typename DataType>
typename Tree<DataType>::PreOrderIterator Tree<DataType>::beginPreOrder() const
{
...
template<typename DataType>
typename Tree<DataType>::PreOrderIterator Tree<DataType>::endPreOrder() const
{
...
template<typename DataType>
typename Tree<DataType>::PostOrderIterator Tree<DataType>::begin() const
{
...
template<typename DataType>
typename Tree<DataType>::PostOrderIterator Tree<DataType>::end() const
{
...
template<typename DataType>
typename Tree<DataType>::ReversePostOrderIterator Tree<DataType>::rbegin() const
{
...
template<typename DataType>
typename Tree<DataType>::ReversePostOrderIterator Tree<DataType>::rend() const
{
...
template<typename DataType>
typename Tree<DataType>::LeafIterator Tree<DataType>::beginLeaf() const
{
...
template<typename DataType>
typename Tree<DataType>::LeafIterator Tree<DataType>::endLeaf() const
{
...
template<typename DataType>
Tree<DataType>::Iterator::Iterator()
   : m_node(nullptr),
   m_head(nullptr)
{
}
...
template<typename DataType>
Tree<DataType>::Iterator::Iterator(const Iterator& other)
   : m_node(other.m_node),
   m_head(other.m_head)
{
}
...
template<typename DataType>
Tree<DataType>::Iterator::Iterator(std::shared_ptr<TreeNode<DataType>> node)
   : m_node(node),
   m_head(nullptr)
{
}
...
template<typename DataType>
Tree<DataType>::Iterator::Iterator(std::shared_ptr<TreeNode<DataType>> node, std::shared_ptr<TreeNode<DataType>> head)
   : m_node(node),
   m_head(head)
{
}
...
template<typename DataType>
Tree<DataType>::Iterator::operator bool() const
{
...
template<typename DataType>
TreeNode<DataType>& Tree<DataType>::Iterator::operator*()
{
   return *m_node;
}
...
template<typename DataType>
const TreeNode<DataType>& Tree<DataType>::Iterator::operator*() const
{
   return *m_node;
}
...
template<typename DataType>
bool Tree<DataType>::Iterator::operator==(const Iterator& other) const
{
...
template<typename DataType>
typename Tree<DataType>::SiblingIterator Tree<DataType>::Iterator::begin() const
{
...
template<typename DataType>
typename Tree<DataType>::SiblingIterator Tree<DataType>::Iterator::end() const
{
...
template<typename DataType>
Tree<DataType>::SiblingIterator::SiblingIterator()
   : Iterator()
{
}

template<typename DataType>
Tree<DataType>::SiblingIterator::SiblingIterator(const Iterator& other)
   : m_node(other.m_node),
   m_head(other.m_head)
{
}
...
template<typename DataType>
Tree<DataType>::SiblingIterator::SiblingIterator(std::shared_ptr<TreeNode<DataType>> node)
   : Iterator(node)
{
}

template<typename DataType>
typename Tree<DataType>::SiblingIterator Tree<DataType>::SiblingIterator::operator++(int)
{
   auto result = *this;
   ++(*this);
...
template<typename DataType>
typename Tree<DataType>::SiblingIterator& Tree<DataType>::SiblingIterator::operator++()
{
   if (m_node)
   {
...
template<typename DataType>
Tree<DataType>::PreOrderIterator::PreOrderIterator(const Iterator& other)
   : m_node(other.m_node),
   m_head(other.m_head)
{
}
...
template<typename DataType>
Tree<DataType>::PreOrderIterator::PreOrderIterator(std::shared_ptr<TreeNode<DataType>> node)
   : Iterator(node)
{
}
...
template<typename DataType>
typename Tree<DataType>::PreOrderIterator Tree<DataType>::PreOrderIterator::operator++(int)
{
   auto result = *this;
   ++(*this);
...
template<typename DataType>
Tree<DataType>::PostOrderIterator::PostOrderIterator(const Iterator& other)
   : m_node(other.m_node),
   m_head(other.m_head),
   m_haveChildrenBeenVisited(false)
{
...
template<typename DataType>
Tree<DataType>::PostOrderIterator::PostOrderIterator(std::shared_ptr<TreeNode<DataType>> node)
   : Iterator(node),
   m_haveChildrenBeenVisited(false)
{
}
...
template<typename DataType>
typename Tree<DataType>::PostOrderIterator Tree<DataType>::PostOrderIterator::operator++(int)
{
   auto result = *this;
   ++(*this);
...
template<typename DataType>
Tree<DataType>::ReversePostOrderIterator::ReversePostOrderIterator()
   : Iterator()
{
}

template<typename DataType>
Tree<DataType>::ReversePostOrderIterator::ReversePostOrderIterator(const Iterator& other)
   : m_node(other.m_node),
   m_head(other.m_head)
{
}
...
template<typename DataType>
Tree<DataType>::ReversePostOrderIterator::ReversePostOrderIterator(std::shared_ptr<TreeNode<DataType>> node)
   : Iterator(node)
{
}

template<typename DataType>
typename Tree<DataType>::ReversePostOrderIterator Tree<DataType>::ReversePostOrderIterator::operator++(int)
{
   auto result = *this;
   ++(*this);
...
template<typename DataType>
typename Tree<DataType>::ReversePostOrderIterator& Tree<DataType>::ReversePostOrderIterator::operator++()
{
   // When the iterator is at the end(), then the next position should be the head:
   if (!m_node)
   {
...
template<typename DataType>
Tree<DataType>::LeafIterator::LeafIterator()
   : Iterator()
{
}

template<typename DataType>
Tree<DataType>::LeafIterator::LeafIterator(const Iterator& other)
   : m_node(other.m_node),
   m_head(other.m_head)
{
}
...
template<typename DataType>
Tree<DataType>::LeafIterator::LeafIterator(std::shared_ptr<TreeNode<DataType>> node)
   : Iterator(node)
{
}

template<typename DataType>
typename Tree<DataType>::LeafIterator Tree<DataType>::LeafIterator::operator++(int)
{
   auto result = *this;
   ++(*this);
...
template<typename DataType>
typename Tree<DataType>::LeafIterator& Tree<DataType>::LeafIterator::operator++()
{
   assert(m_node);
